...
<body class="text-gray-800">
    ...
    <main>
        ...
        <section id="penawaran-terbatas" class="py-20 hero-gradient text-white"><div class="container mx-auto px-6 text-center"><i data-lucide="clock" class="w-16 h-16 mx-auto mb-4"></i><h2 class="text-3xl md:text-4xl font-bold mb-4">Jangan Sampai Ketinggalan!</h2><p class="text-lg max-w-3xl mx-auto mb-8">Penawaran EKSKLUSIF ini hanya berlaku hingga Selasa, 5 Agustus 2025. Amankan unitmu sebelum kuota habis!</p><div id="countdown" class="grid grid-cols-4 gap-4 max-w-2xl mx-auto"><div class="countdown-box"><span id="days" class="countdown-number">00</span><br><span class="countdown-label">Hari</span></div><div class="countdown-box"><span id="hours" class="countdown-number">00</span><br><span class="countdown-label">Jam</span></div><div class="countdown-box"><span id="minutes" class="countdown-number">00</span><br><span class="countdown-label">Menit</span></div><div class="countdown-box"><span id="seconds" class="countdown-number">00</span><br><span class="countdown-label">Detik</span></div></div><br><br><video width="100%" controls class="rounded-lg shadow-lg"><source src="assets/video/video.mp4" type="video/mp4">Your browser does not support the video tag.</video></div></section>
        ...
        <div class="container mx-auto px-6 max-w-3xl">
            ...
            <form id="registrationForm" novalidate class="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div><label for="nomor_induk_karyawan" class="block font-semibold mb-1">Nomor Induk Karyawan</p><input type="text" id="nomor_induk_karyawan" name="nomor_induk_karyawan" placeholder="NIK Perusahaan" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition" required></div>
