    ...
    <div class="p-6 border border-gray-200 rounded-lg">
        ...
        <fieldset <?php echo (!$is_fully_editable) ? 'disabled' : ''; ?>>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- [UPDATE v2.4] Field Edit Nama Perusahaan -->
                <div><label for="nama_perusahaan" class="block font-semibold mb-1">Nama Perusahaan</label><input type="text" id="nama_perusahaan" name="nama_perusahaan" value="<?php echo htmlspecialchars($participant['nama_perusahaan']); ?>" class="w-full p-3 border border-gray-300 rounded-lg" required></div>
