...
while ($row = $result->fetch_assoc()) {
    ...
    $html .= '<td style="vertical-align: top;">' . ucfirst($row['status_perkawinan']) . '<br><small>Penghasilan Sesuai: ' . ucfirst($row['penghasilan_sesuai']) . '</small></td>';
    ...
    if ($row['status_perkawinan'] == 'menikah') {
        ...
        $html .= '<td colspan="2" align="center" style="vertical-align: middle;">-</td>';
    }
...
$conn->close();
$pdf->Output('data-peserta-rumah-merdeka.pdf', 'I');
