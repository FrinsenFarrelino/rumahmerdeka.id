...
$sheet->mergeCells('A1:O1')->setCellValue('A1', 'Data Peserta Program Rumah Merdeka');
$sheet->getStyle('A1')->getFont()->setBold(true)->setSize(16);
$sheet->getStyle('A1')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);

$sheet->mergeCells('A2:O2')->setCellValue('A2', 'Dokumen dibuat pada: ' . date('d F Y, H:i:s'));
